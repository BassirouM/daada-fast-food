...
type CartState = {
  ...
  setAdresseLivraison: (addr: AdresseLivraison | null) => void
...
export const useCartStore = create<CartState>()(
  persist(
    (set, get) => ({
      ...
      setAdresseLivraison: (addr) => set({ adresseLivraison: addr }),

      applyPromoCode: (code, discount) => set({ promoCode: code, discount }),

      clearCart: () =>
        set({ items: [], deliveryAddressId: null, adresseLivraison: null, promoCode: null, discount: 0 }),
